 ...
 * HTML5 localStorage.
 *
 * Developed by Reshad Noorzay <@ReshadN>
 *
 * Version 0.5 - Last updated: Dec 18 2010
 *
 * Inspired by monkeeTime https://github.com/monkeecreate/monkeeTime
 * and Checklist from http://miniapps.co.uk/
 */

$(document).ready(function() {
	if (typeof(localStorage) == 'undefined' ) {
		alert('Your browser does not support HTML5 localStorage. Try upgrading to Google Chrome.');
	} 
	else {
		getAllItems();
